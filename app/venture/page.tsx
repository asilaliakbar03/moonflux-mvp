  ...
  return (
    <div className="max-w-5xl mx-auto w-full pt-8 pb-16">
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col md:flex-row justify-between items-center gap-6 mb-10 text-center md:text-left">
        ...
        <div className="flex p-1 bg-[#0D1117] border border-[rgba(99,102,241,0.2)] rounded-xl shadow-[0_0_15px_rgba(99,102,241,0.1)]">
          <button
        ...
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div className="fluxx-card p-5">
              ...
              <div className="text-3xl font-mono font-bold text-[#6366F1] drop-shadow-[0_0_5px_rgba(99,102,241,0.3)]">12</div>
            </div>
            <div className="fluxx-card p-5">
              <div className="text-[#94A3B8] text-sm font-semibold mb-1">Treasury Value</div>
              <div className="text-3xl font-mono font-bold text-[#10B981] drop-shadow-[0_0_5px_rgba(16,185,129,0.3)]">$4.2M</div>
            </div>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {PROPOSALS.map((prop) => (
              <div key={prop.id} className="fluxx-card p-6 flex flex-col h-full transition-all hover:border-[rgba(99,102,241,0.4)] hover:shadow-[0_0_15px_rgba(99,102,241,0.15)] border border-transparent">
                  ...
                  <div>
                    <div className="flex gap-2 mb-2">
                      <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded border ${
                        prop.status === 'Active' ? 'bg-[rgba(99,102,241,0.15)] text-[#818CF8] border-transparent' :
                        prop.status === 'Passed' ? 'bg-[rgba(16,185,129,0.15)] text-[#10B981] border-transparent' :
                        'bg-[rgba(244,63,94,0.15)] text-[#F43F5E] border-transparent'
                      }`}>
                        {prop.status}
                      </span>
                      <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded border ${
                        prop.category === 'Protocol' ? 'bg-[rgba(99,102,241,0.15)] text-[#818CF8] border-[rgba(99,102,241,0.3)]' :
                        prop.category === 'Economics' ? 'bg-[rgba(245,158,11,0.15)] text-[#F59E0B] border-[rgba(245,158,11,0.3)]' :
                ...
                <div className="mb-6 mt-auto">
                  ...
                  <div className="h-2 w-full bg-[#080B12] rounded-full overflow-hidden flex border border-[rgba(255,255,255,0.05)]">
                    <div className="h-full bg-[#10B981] shadow-[2px_0_8px_rgba(16,185,129,0.6)]" style={{ width: `${prop.forPct}%` }} />
                    <div className="h-full bg-[#F43F5E] shadow-[-2px_0_8px_rgba(244,63,94,0.6)]" style={{ width: `${100 - prop.forPct}%` }} />
                  </div>
                ...
                {prop.status === 'Active' && (
                  <div className="flex gap-3">
                    <button 
                      ...
                      className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg font-bold text-sm transition-all active:scale-95 border ${
                        votedProps[prop.id] === 'for' 
                          ...
                          : 'bg-gradient-to-r from-[#10B981]/10 to-[#059669]/10 hover:from-[#10B981]/20 hover:to-[#059669]/20 border-[#10B981]/30 text-[#10B981]'
                      }`}
                    >
                    ...
                    <button 
                      ...
                      className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg font-bold text-sm transition-all active:scale-95 border ${
                        votedProps[prop.id] === 'against' 
                          ...
                          : 'bg-gradient-to-r from-[#F43F5E]/10 to-[#E11D48]/10 hover:from-[#F43F5E]/20 hover:to-[#E11D48]/20 border-[#F43F5E]/30 text-[#F43F5E]'
                      }`}
                    >
      ...
      {activeTab === 'incubator' && (
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="flex flex-col gap-6">
          ...
          <div className="fluxx-card p-8 border border-[rgba(99,102,241,0.3)] bg-[rgba(99,102,241,0.02)] flex flex-col items-center text-center mb-4 relative overflow-hidden shadow-[0_0_20px_rgba(99,102,241,0.1)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {INCUBATOR_PROJECTS.map((proj) => (
              <div key={proj.id} className="fluxx-card p-6 flex flex-col h-full hover:border-[rgba(99,102,241,0.5)] hover:shadow-[0_0_20px_rgba(99,102,241,0.15)] transition-all border border-transparent">
                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className={`text-[10px] uppercase font-bold px-2 py-1 rounded flex items-center gap-1.5 ${
                    proj.stage === 'Ready' ? 'text-[#10B981] bg-[rgba(16,185,129,0.1)]' : 
                    proj.stage === 'Growth' ? 'text-[#818CF8] bg-[rgba(99,102,241,0.1)]' : 
                ...
                <div className="mb-6">
                  ...
                  <div className="h-2 w-full bg-[#080B12] rounded-full overflow-hidden border border-[rgba(255,255,255,0.05)]">
                    <div className="h-full relative w-full" style={{ width: `${proj.raised}%` }}>
                ...
                <button 
                  ...
                  className={`w-full py-3 rounded-lg font-bold text-sm transition-all flex items-center justify-center gap-2 active:scale-95 ${
                    votedProjects[proj.id] 
                      ? 'bg-[rgba(99,102,241,0.2)] text-[#818CF8] border border-[#6366F1]/50' 
                      : 'bg-[#6366F1] hover:bg-[#4F46E5] text-white shadow-[0_0_15px_rgba(99,102,241,0.4)]'
                  }`}
                >
